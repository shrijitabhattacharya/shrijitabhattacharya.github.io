...
Reproducibility
======
* [Neural Autoregressive Flows based Variational Bayes Model Averaging](https://github.com/Jiefu-git/NAF-BMA.git). (2026) *The American Statistician* (accepted).
* [Variational inference aided variable selection for spatially structured high dimensional covariates](https://github.com/shrijitabhattacharya/VI-aided-variable-selection-with-Ising) (2025) *Journal of Computational and Graphical Statistics* 35(1):482-493.
* [Spike-and-slab shrinkage priors for structurally sparse Bayesian neural networks](https://github.com/jsanket12/SS_Group_Shrinkage_New) (2024) *IEEE Transactions on Neural Networks and Learning Systems* 36(6):11176-11188.
